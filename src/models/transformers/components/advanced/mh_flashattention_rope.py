...
class MultiHeadFlashAttentionRope(nn.Module):
    """
    Use the Flash attention mechanism (https://arxiv.org/abs/2205.14135) with rotary positional embeddings (https://arxiv.org/abs/2104.09864).
    """
